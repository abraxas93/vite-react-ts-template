...
export const Input = memo((props: InputProps) => {
  ...
  const mods: Mods = {
    ...
    [cls.withAddonLeft]: Boolean(leftNode),
    [cls.withAddonRight]: Boolean(rightNode),
  };
  const input = (
    <div
      className={addClasses(cls.InputWrapper, mods, [
        className,
        cls[size],
      ])}
    >
      <div className={cls.addonLeft}>{leftNode}</div>
      <input
        ref={ref}
        type={type}
        value={value}
